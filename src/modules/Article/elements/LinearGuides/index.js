...
export const LinearGuides = (props) => {
  const [currentSlide, setCurrentSlide] = useState(0); // gerenciando o estado atual do slide

  const paragraphs = [
    <img src={image40} className="image1" alt="image40" width="40%" height="40%" />,
    <img src={image41} className="image1" alt="image41" width="40%" height="40%" />,
    <img src={image42} className="image1" alt="image42" width="40%" height="40%" />,
    <img src={image43} className="image1" alt="image43" width="40%" height="40%" />,
    <img src={image44} className="image1" alt="image44" width="40%" height="40%" />,
    // <img src= {image45} className="image1" alt="image1" width="40%" height="40%"/>, 
    <img src={image46} className="image1" alt="image46" width="40%" height="40%" />,
    <img src={image47} className="image1" alt="image47" width="40%" height="40%" />,
    <img src={image48} className="image1" alt="image48" width="40%" height="40%" />,
    <img src={image49} className="image1" alt="image49" width="40%" height="40%" />,
    <img src={image50} className="image1" alt="image50" width="40%" height="40%" />,
    <img src={image51} className="image1" alt="image51" width="40%" height="40%" />,
  ];
  ...
  return (
    <HelmetComponent element="LinearGuides">
      <S.Container>
        <S.Wrapper>
